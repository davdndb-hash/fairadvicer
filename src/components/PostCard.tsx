...
export default function PostCard({
  ...
  return (
    <article className="group relative flex h-full flex-col border-t border-line pt-6 transition-colors hover:border-brand-400">
      <div className="flex items-center gap-3 text-[0.74rem] font-semibold uppercase tracking-[0.12em] text-brand-600">
        <span>{audience}</span>
      ...
      <h3 className="mt-3 font-display text-[1.55rem] leading-tight text-ink transition-colors group-hover:text-brand-700 balance">
